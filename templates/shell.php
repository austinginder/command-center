...
<body class="min-h-screen flex flex-col bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 font-sans antialiased">

<!-- Navigation -->
<nav class="sticky top-0 z-40 bg-zinc-50/90 dark:bg-zinc-950/90 backdrop-blur border-b border-zinc-200 dark:border-zinc-800">
    <div class="max-w-5xl w-full mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
        <a href="/" data-route class="flex items-center gap-2.5 text-zinc-900 dark:text-zinc-100">
            ...
            <span class="flex flex-col justify-center gap-1 leading-none">
                ...
                <span class="font-mono text-[10px] tracking-[0.3em] text-zinc-400 dark:text-zinc-600">SESSION INDEX</span>
            </span>
        </a>
        <div class="flex items-center gap-3">
            <span id="index-status" class="hidden sm:inline text-xs font-mono text-zinc-400 dark:text-zinc-500"></span>
            <button id="dark-toggle" type="button" class="text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 p-1 rounded transition-colors" title="Toggle dark mode">
